...
## [0.2.10](https://github.com/colibri-social/appview/compare/v0.2.9...v0.2.10) - 2026-08-21

### Fixed

- dedupe member records and fix duplicate creation

## [0.2.9](https://github.com/colibri-social/appview/compare/v0.2.8...v0.2.9) - 2026-08-21

### Added

- video proxying

## [0.2.8](https://github.com/colibri-social/appview/compare/v0.2.7...v0.2.8) - 2026-08-14

### Added

- removable embeds
- cross-appview moderation
- optional `filename` param for downloads

### Fixed

- large embed images by default

## [0.2.7](https://github.com/colibri-social/appview/compare/v0.2.6...v0.2.7) - 2026-08-10

### Fixed

- Transmit live status of Tap events
- more message deletion data, stop dropping events
- keep user state across multiple devices

### Other

- Sync lexicons

## [0.2.6](https://github.com/colibri-social/appview/compare/v0.2.5...v0.2.6) - 2026-08-06

### Fixed

- Ensure only mic sound counts as speaking

## [0.2.5](https://github.com/colibri-social/appview/compare/v0.2.4...v0.2.5) - 2026-08-06

### Added

- Delete Colibri data from AppView ([#82](https://github.com/colibri-social/appview/pull/82))
- image metadata transmission ([#81](https://github.com/colibri-social/appview/pull/81))

### Other

- Update sync-lexicons.yml

## [0.2.4](https://github.com/colibri-social/appview/compare/v0.2.3...v0.2.4) - 2026-08-03

### Added

- WebP support for community picture and banner ([#78](https://github.com/colibri-social/appview/pull/78))

## [0.2.3](https://github.com/colibri-social/appview/compare/v0.2.2...v0.2.3) - 2026-08-01

### Added

- Proper error reporting with error codes

### Fixed

- widen auth scope for read markers
- Only disconnect user from VC when joining VC from other device
...
- allow removing avatars and banners

## [0.2.0](https://github.com/colibri-social/appview/compare/v0.1.14...v0.2.0) - 2026-07-28

### Added

- [**breaking**] community banners ([#71](https://github.com/colibri-social/appview/pull/71))
- lexicon tests ([#72](https://github.com/colibri-social/appview/pull/72))

### Fixed

- set indexed_at for community and mod writes
- channel dragging/updating
- better PDS unreachable errors
...
- Pings ([#65](https://github.com/colibri-social/appview/pull/65))

## [0.1.12](https://github.com/colibri-social/appview/compare/v0.1.11...v0.1.12) - 2026-07-24

### Fixed

- Migration ([#63](https://github.com/colibri-social/appview/pull/63))
